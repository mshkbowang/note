...
<body class="gray-bg">
    ...
    <script>
                    ...
                    $('.dataTables-example').DataTable( {
                        ...
                        columnDefs:[{
                            ...
                            render: function (data, type, row, meta) {
                                return '<a type="button" class="btn btn-danger tableBtn" href="#" onclick=delFromByID(' + row.deptId + ') >删除</a>'+
                                		'<a type="button" class="btn btn-info tableBtn" href="#" onclick=editFromByID(' + row.deptId + ') >编辑</a>';
                            }
                        },
        ...
        //通过deptId删除科室信息
        function delFromByID(deptId){
        	layer.confirm('确认删除该科室信息？', {
        		  btn: ['确定','取消'] //按钮
        		}, function(){
        			$.ajax({
                		url: '../deleteDeptById.do',
                		type: 'POST',
                		data: {'deptId':deptId},
                		dataType: 'JSON',
